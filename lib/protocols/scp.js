/**
 * Description:
 * The `ScpClient` class provides functionality for interacting with remote servers using SCP (Secure Copy Protocol). It allows for uploading and downloading files and directories, executing remote commands, and listing remote directories. The class implements retry logic for operations to handle transient errors and supports secure connections using private keys.
 *
 * Purpose of the File:
 * - Establish and manage SCP connections to remote servers.
 ...
 * - List and manage remote directories and their contents.
 * - Provide utilities for loading SCP options from private key files for secure connections.
 */
