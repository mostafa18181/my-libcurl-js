/**
 * Description:
 * The `StreamManager` class provides utility methods for working with streams in Node.js. It includes methods for creating readable, writable, and transform streams, piping streams together, handling file operations like copying, transforming, reading, and writing files, and downloading files from URLs with support for resuming downloads.
 *
 * Purpose of the File:
 * - Manage and manipulate streams effectively in Node.js.
 * - Handle file operations such as reading, writing, transforming, and copying files using streams.
 * - Pipe streams with proper error handling and backpressure management.
 * - Provide utility functions to create streams from data and handle HTTP/HTTPS downloads.
 */
